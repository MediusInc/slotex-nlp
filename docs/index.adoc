= image:slotex_logo.png[Logo,height=65px] 
:toc: left
:imagesdir: images
:docinfo: shared
...
[cols="^,^,^"]
|===
a|image::logo-sklad-kadri.jpg[link=http://www.sklad-kadri.si/,height=65,opts=inline] a|image::logo-mizs.jpg[link=https://www.gov.si/en/public-authorities/ministries/ministry-of-education-science-and-sport/,height=65,opts=inline] a|image::logo-pkp.jpg[link=http://ec.europa.eu/esf/home.jsp?langId=en,height=65,opts=inline]
|===
...
[cols="^,^,^,^"]
|===
a|image::logo.png[link=https://medius.si,height=65] a|image::logo-fe.svg[link=https://fe.uni-lj.si,height=65,opts=inline] a|image::logo-fri.svg[link=https://fri.uni-lj.si,height=65,opts=inline]  a|image:logo-ff.svg[link=https://ff.uni-lj.si,height=65,opts=inline] 
|===
